...
class DemoTest {
    ...
    @Test
    public void should_0_0_E_when_executeCommands_given_0_0_S_and_L() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "S");
        String commands = "L";
    ...
    @Test
    public void should_0_0_N_when_executeCommands_given_0_0_E_and_L() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "E");
        String commands = "L";
    ...
    @Test
    public void should_0_0_S_when_executeCommands_given_0_0_W_and_L() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "W");
        String commands = "L";
    ...
    @Test
    public void should_0_0_E_when_executeCommands_given_0_0_N_and_R() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "N");
        String commands = "R";
    ...
    @Test
    public void should_0_0_W_when_executeCommands_given_0_0_S_and_R() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "S");
        String commands = "R";
    ...
    @Test
    public void should_0_0_S_when_executeCommands_given_0_0_E_and_R() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "E");
        String commands = "R";
    ...
    @Test
    public void should_0_0_N_when_executeCommands_given_0_0_W_and_R() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "W");
        String commands = "R";
